...
public class AuthDomainServiceImpl implements AuthDomainService {
    ...
    private static final String AUTH_FAIL_CODE = "AUTH_FAIL";
    private static final String AUTH_FAIL_MSG = "邮箱或密码错误";
    ...
    public ResultDO<UserAggregate> authenticate(LoginParam param) {
        try {
            ...
            if (aggregate == null || aggregate.getUserEntity() == null) {
                return ResultDO.buildFailResult(AUTH_FAIL_CODE, AUTH_FAIL_MSG);
            }
            ...
            if (!UserStatusEnum.ENABLED.equals(aggregate.getUserEntity().getStatus())) {
                return ResultDO.buildFailResult("USER_DISABLED", "账号已被禁用，请联系管理员");
            }
