...
+ **适配器层**（`inAdaptor/outAdaptor`）实现**应用层**定义的接口（如Adaptor接口）
...
| 规范 | 地址 |
| --- | --- |
| ddd-model-layer | [ddd-model-layer.md](ddd-model-layer.md) |
...
| ddd-client-layer | [ddd-client-layer.md](ddd-client-layer.md) |
